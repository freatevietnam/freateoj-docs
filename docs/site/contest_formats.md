...
For example, say a submission with a score of 50/100 is submitted 23 minutes before the contest ends. $\lfloor\frac{23}{5}\rfloor = 4$, so 4 bonus points are awarded, giving a total score of $50 + 4 = 54$ for that problem.
