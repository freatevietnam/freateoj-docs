...
Follow the installation instructions of Mathoid. Moving forward, we'll assume that
you are running Mathoid on `localhost:8888`.

## Configuring FreateOJ to use Mathoid

Assuming Mathoid is installed, configuring FreateOJ to generate math with it requires the addition of a few lines
